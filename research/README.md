...
- **E12 — proximity search:** local cold probes passed after fixing schema-derived facet rejection and place-name geocoding friction (`findings/2026-07-14-location-search.md`). Production verification is the remaining agent-layer gate; mapped coverage is still only 8/393 region-attributed pages.
