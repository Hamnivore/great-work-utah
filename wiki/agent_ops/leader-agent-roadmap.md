...
- 2026-06-25: Command Center integration pass (continued from prior source-recovery session). Linked 9 orphan source records to target pages; renamed 9 legacy `-md` venture files to proper `.md`; removed 3 duplicates; migrated 4 legacy venture pages to wiki schema; fixed 1 uncited venture (energy-solutions). Checks: lint 0 errors/warnings, build 636 entries, source records 197/197 (100%), uncited=1 (by-design). Next: source records for 11 ventures with only raw https:// evidence; guides source coverage.
- 2026-06-25: Claimed `wiki/agent_ops/locks/2026-06-25-1052-ask-runtime-hardening.md`. Completed Ask/Runtime hardening with 2 explorer subagents: cleared remaining Trigger.dev v3 imports, gated public/scheduled wiki writes, validated GitHub wiki write paths, added 15m trigger token TTL, and repaired adjacent missing source records. Checks: runtime ESLint clean, wiki lint 0 errors/warnings, build 636 entries, source coverage 0 errors. Next: authenticated admin/review queue for write-capable wiki drafting.
- 2026-06-25: Claimed `wiki/agent_ops/locks/2026-06-25-person-matches-integration.md`. Command Center pass (committed accumulated venture renames, 20+ person-centered match pages, src fixes). Superseded 2 stale claims. Wrote 3 person↔venture match pages for Josh James↔Domo, Aaron Skonnard↔Pluralsight, Ryan Smith↔Qualtrics. Matches=37, build=636 entries, lint 0 errors. Next: second people batch (Recursion/Fortem/Halia founders) or source-coverage audit for guides.
- 2026-06-25: Claimed/superseded into `wiki/agent_ops/locks/2026-06-25-person-centered-matches.md`. Completed person-centered Judgment Layer slice and follow-up integration: matches=37, wiki build=636 entries, `src/lib/matches.ts` now formats `person:`/helper/resource/work party refs. Checks: wiki lint/build clean; touched match library lint clean. Next: guide-level synthesis over person matches or source-strength audit for helper/resource matches.
- 2026-06-21: Command Center pass + Frontend Wiki UX completion. Closed 4 stale active claims (migration-factory-final-wave, -wave2, people-pages-first-wave, application-data-contract). Fixed 3 remaining legacy source IDs in `src/` (`_shared.ts` FEATURED_IDS, `matches.ts` link rewriter, `HowItWorks.tsx` nav links) — prior agent had already fixed Directory.tsx and Entry.tsx. TypeScript: 0 errors, build: 604 entries. Next: Ask/Runtime (Trigger.dev v4) or person↔helper match pages.
- 2026-06-21: Claimed `wiki/agent_ops/locks/2026-06-19-people-pages-first-wave.md`. Built people layer from 0→12 pages; cleared 39 lint errors left by prior venture-page wave (missing source stubs, legacy-provenance). Checks: lint 0 errors, build 604 entries, people=12, ventures=108, sources=194. Next: person↔venture/helper match pages; source-coverage audit for guides.
- 2026-06-21: Claimed `wiki/agent_ops/locks/2026-06-19-migration-factory-wave2.md`. Completed Migration Factory Wave 2 across all remaining legacy categories (energy, manufacturing, space, transportation, sci-infra, bio, health, other, art-and-meaning, food-and-agriculture). 5 parallel subagents + boss batch. All ~44 legacy entries now have venture pages; created 12+ missing source records; removed 2 duplicate venture pages; fixed 1 legacy-provenance lint error. Checks: lint 0 errors (603 files), build 603 entries, ventures=108, sources=194, people=12. Next: guides source coverage (7 guides lack cites); person↔venture matches; source-coverage audit.
...
- 2026-06-21: People-pages integration pass (continuation). Completed 9 people pages (josh-james, dave-bearss, florian-solzbacher, ryan-smith-qualtrics, ryan-smith-imsar, aaron-skonnard, karl-sun, tim-latimer, chad-testa); all broken wiki/people/ links resolved. Claim `2026-06-19-migration-factory-wave2.md` marked done. Checks: lint 0 errors (604 files), build 604 entries, people=12.
