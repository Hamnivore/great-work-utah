...
It is less likely to be the cheapest option for a pre-revenue solo founder who only needs an LLC and a template operating agreement; that founder may start with [Utah SBDC](../resources/utah-sbdc.md) or [SCORE Utah](../resources/score-utah.md) for business basics and bring in firm-level counsel when equity, investors, or IP assignment enter the picture.
...
- [Kirton McConkie Official Website](../sources/kirton-mcconkie-official-website.md)
