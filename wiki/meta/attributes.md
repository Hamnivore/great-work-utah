...
| Map Location | venture, helper, resource, work | optional; required with any map field | public Utah site or area label at the same granularity as Coordinates; never a residence, private workplace, or person location | regional overlay, map display |
