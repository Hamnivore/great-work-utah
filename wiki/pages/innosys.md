...
**Stage:** Operating since 2000; privately held, sustained by SBIR/STTR and defense contracts across DoD, DOE, and NASA
**Primary Location:** Salt Lake City, UT
**Utah Location:** 2900 S Main St, Salt Lake City, UT 84115
**Region:** Salt Lake City
**Website:** https://www.innosystech.com
**Domain:** aerospace-defense, materials-mfg
**Updated:** 2026-08-13
**Needs-reviewed:** 2026-08-13
**Pull:** *Vacuum tubes rebuilt with MEMS — electronics that keep working at 650°C, through radiation and EMP, where silicon simply stops.*
**Relates:** cites [Source: InnoSys SBIR Award](innosys-official-website.md) · https://greatutah.work/pages/innosys-official-website.md · https://www.sbir.gov/awards/196910
...
- [Source: InnoSys SBIR Award](innosys-official-website.md) · https://greatutah.work/pages/innosys-official-website.md · https://www.sbir.gov/awards/196910 — DOE SBIR Phase II, $995,092, contract DE-SC0021772, 2022; PI Larry Sadwick; establishes the Salt Lake City address and UEI SKSZV1JCCLJ7.
...
- [ACT Aerospace](act-aerospace.md) · https://greatutah.work/pages/act-aerospace.md — another Utah precision manufacturer serving defense-adjacent markets.
- [Nielson Scientific](nielson-scientific.md) · https://greatutah.work/pages/nielson-scientific.md — a second Utah microfabrication shop built on federal R&D awards.
...
- Headcount, revenue, and total federal awards to date are not public in sources reviewed. An SBIR portfolio aggregate for UEI `SKSZV1JCCLJ7` would settle the last of these.
- `cik=0000720694` resolves to an SEC registrant named "INNOSYS INC" with two REGDEX filings (2003-09-08 and 2004-08-05) and no address in the EDGAR record. The dates are consistent with this company raising private capital, but the identifier is not independently confirmed as the same entity and should be treated as provisional.
- The older `innosys.com` and `innosysinc.com` domains fail TLS with expired certificates; `innosystech.com` is the live site. Whether the old domains were ever this company's is unverified.
- What is the year of the AFWERX Direct-to-Phase-II award? The announcement gives January 27 without a year.

## Maintainer Notes

- This page previously described InnoSys as a fiber-optic glass-to-metal seal company with unknown location and `**Tier:** unranked`. That framing came from a single DOE SBIR abstract; the seals are one project, not the company. Rewritten 2026-08-13 from the company's own site, the award records, and the patents.
- The source page `innosys-official-website.md` is titled "Source: InnoSys SBIR Award" and documents an SBIR record, so its slug is wrong for its atom. Renaming would break the inbound link; fix during a slug pass, not in isolation.
- Worth adding: a map tuple for 2900 S Main St, Salt Lake City (coordinates not yet looked up), and source pages for the official website, the AFWERX announcement, and the patents.
