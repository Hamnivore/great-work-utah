# Official Website: Lucid Software

**Type:** source
**Status:** Useful
**Confidence:** Medium
**Source Type:** official-page
**URL:** https://lucid.co/platform/visual-collaboration
...
Lucid Software's official website describes a visual collaboration platform company behind Lucidchart (cloud diagramming) and Lucidspark (virtual whiteboarding), aimed at teams documenting processes, aligning on ideas, and collaborating in real time.
...
> A work acceleration platform powered by visual collaboration, Lucid brings everyone and everything together. Capture and execute the full picture of work.

> Together, Lucidchart for intelligent diagramming and Lucidspark for virtual whiteboarding provide an end-to-end solution for visual collaboration.

Locator: Visual collaboration for effective teamwork; Lucid products.
