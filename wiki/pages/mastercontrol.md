...
Cottonwood Heights-based MasterControl sells quality and manufacturing software for drug, device, biotech, and other regulated producers ([official site](mastercontrol-official-website.md)). It makes no therapy itself, but compliance systems become quiet infrastructure across many factories; the limit is a category with credible rivals such as Veeva.
...
- **Cottonwood Heights vs. Salt Lake City.** MasterControl's own contact page lists its headquarters mailing address as "Salt Lake City, UT 84121," while Utah government sources describe the same address as "Cottonwood Heights, Utah." Is there a municipal-boundary distinction that explains the conflicting place names?
- **EDTIF incentive size discrepancy.** GOEO's public award page and board materials describe conflicting terms for MasterControl's expansion ([GOEO source](mastercontrol-edtif-expansion.md)). This page does not resolve which record is authoritative.
...
- **Revenue and current valuation.** Current scale has not been verified from a captured primary source and should be confirmed before use in any recommendation.
...
- Compare nearby [Instructure](instructure.md), currently attributed to Salt Lake City, and settle whether the two Old Mill office-park pages need consistent city attribution or sit across a real municipal boundary.
- Earlier intake figures for revenue and valuation date to the Sixth Street Growth investment; do not restore them without a captured primary source.
