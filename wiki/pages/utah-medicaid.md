...
Eligibility varies by program, household circumstances, income, age, pregnancy, disability, and other rules. A prior denial does not establish current ineligibility; the official application process is the appropriate way to obtain a determination.

## How To Use It

- Start at https://medicaid.utah.gov/apply-medicaid/ for the current online, mail, fax, and in-person application options. Online applications go through Utah's myCase system.
- For application help, call the Department of Workforce Services at 1-866-435-7414, or 801-526-0950 in Salt Lake County.
- If applying for nursing-home or other long-term-care Medicaid, use the medical application plus the Long Term Care Addendum identified on the application page.
- For temporary coverage while an ongoing application is decided, review presumptive eligibility for pregnancy or qualifying hospital patients at https://medicaid.utah.gov/presumptive-eligibility/.
- Members and providers can use https://medicaid.utah.gov/ for program, managed-care, pharmacy, provider-enrollment, claims, and PRISM links.
