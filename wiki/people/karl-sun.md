...
- [Lucid Software](../ventures/lucid-software.md) — venture page
...
- The placeholder hero should be replaced with a cleared headshot or event photo when rights are confirmed.
