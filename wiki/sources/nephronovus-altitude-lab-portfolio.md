# Altitude Lab Portfolio: NephroNovus
...
Altitude Lab's public portfolio lists NephroNovus as a therapeutics company estimated founded in 2023, categorized as **Alumni**, with a one-line description of chronic kidney disease drug discovery combining biochemical pathway exploration and computational techniques. A linked resident story by co-founder Kevin Yang (April 2025) adds founder narrative and a stated focus on renal fibrosis but is not a pipeline or funding disclosure.

## Useful Claims

- Portfolio entry name: **NephroNovus**.
- Listed industry: **Therapeutics**.
...
- [NephroNovus](../ventures/nephronovus.md)
