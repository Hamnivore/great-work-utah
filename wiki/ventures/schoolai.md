...
**Relates:** cites [Official Website: SchoolAI](../sources/schoolai-official-website.md)
...
Per the official website, SchoolAI's product stack includes:

1. **Spaces** — teacher-authored AI learning experiences; students interact with a personalized tutor (Dot) within boundaries the teacher sets.
2. **Mission Control** — dashboard showing engagement, struggle points, and suggested teacher interventions while AI works with individual students.
3. **PowerUps** — focused AI apps for student creation, practice, and exploration.
4. **Browser Extension** — AI feedback and lesson tools inside existing teacher workflows.
...
Useful helpers include district superintendents and Utah state education leaders (early adopters), ESSA evaluation partners, FERPA/COPPA legal specialists, and classroom teachers willing to co-design Spaces. [Instructure](instructure.md) already appears as an independent research reviewer — a natural integration and distribution conversation given Canvas's LMS footprint.

## Utah Context

SchoolAI is one of the fastest-scaling recent additions to Utah's Silicon Slopes edtech cluster alongside [Instructure](instructure.md) (Canvas LMS), [Pluralsight](pluralsight.md) (technology skills), and [Lucid Software](lucid-software.md) (visual collaboration). Utah's state-level AI-in-education momentum (including 2025 federal executive-order tailwinds cited in local press) gave SchoolAI a favorable early market. The company moved to a Lehi headquarters and reports deep Utah district penetration.

## Evidence

- [Official Website: SchoolAI](../sources/schoolai-official-website.md)
