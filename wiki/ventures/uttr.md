...
**Relates:** cites [Source: Hill AFB Utah Test and Training Range Fact Sheet](../sources/utah-test-training-range-source.md)
...
This is not a company or a typical startup career path. It is listed in ventures because it is enabling infrastructure that shapes what Utah-based defense and space companies can do locally. See also the deeper institutional history at [Utah Test and Training Range](../work/utah-test-and-training-range.md).
...
- [Source: Hill AFB Utah Test and Training Range Fact Sheet](../sources/utah-test-training-range-source.md)
