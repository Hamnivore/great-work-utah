...
- [By founder usefulness](founder-resource-tier-list.md) · `https://greatutah.work/views/founder-resource-tier-list.md` — a second ladder over the 246 resource and helper pages, ranked by what they hand a founder rather than by world impact; 3 in S, A, and B
...
- [ventures](ventures.md) · `https://greatutah.work/views/ventures.md` — 173 companies, labs, initiatives (with needs inline)
- [resources](resources.md) · `https://greatutah.work/views/resources.md` — 249 grants, accelerators, facilities, capital paths
