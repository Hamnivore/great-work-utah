...
- **Read the best of it first:** [the tier list](tier-list.md) · `https://greatutah.work/views/tier-list.md` ranks all 485 fact pages on one impact ladder. The 37 pages in **S** and **A** are the gems. Pages still being done are marked (active). The letter is how far a thing could move the world, not a vote that it's good — the top of the list includes weapons, surveillance, and mines.
